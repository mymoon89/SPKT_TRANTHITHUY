...
//
// TRAN T DUNG fai sua tiep o day :D

    //DEBUG('a', "virtual page m # %d, pageSize %d, vpn %d too large for page table size %d, offset %d!\n", 
//			virtAddr, PageSize, vpn, pageTableSize, offset);
	...
	if (vpn >= pageTableSize) {
	    ...
	    DEBUG('a', "virtual page n # %d too large for page table size %d, PageSize %d!\n", 
			vpn, pageTableSize,PageSize);
